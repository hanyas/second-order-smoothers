...
from newton_smoothers.batch.utils import log_posterior_cost, line_search_update
...
def line_search_iterated_batch_newton_smoother(
    ...
    flat_nominal, costs = _line_search_newton(
        x0=flat_init_nominal, fun=_flat_log_posterior_cost, k=nb_iter
    )
