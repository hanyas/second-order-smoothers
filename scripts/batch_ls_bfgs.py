...
from optsmooth.batch._ls_bfgs import line_search_iterated_batch_bfgs_smoother
...
smoothed_traj, costs = line_search_iterated_batch_bfgs_smoother(observations, init_dist,
                                                                trns_mdl, obs_mdl,
