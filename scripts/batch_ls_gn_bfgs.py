...
from optsmooth.batch._ls_gn_bfgs import line_search_iterated_batch_gn_bfgs_smoother
...
smoothed_traj, costs = line_search_iterated_batch_gn_bfgs_smoother(observations, init_dist,
                                                                   trns_mdl, obs_mdl,
                                                                   extended, init_nominal_mean,
                                                                   nb_iter=50)

plt.figure(figsize=(7, 7))
plt.plot(smoothed_traj[:, 0], smoothed_traj[:, 1], "-*", label="Iterated Batch GN-BFGS Smoother")
