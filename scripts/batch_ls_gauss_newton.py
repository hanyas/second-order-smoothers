...
from optsmooth.batch._ls_gauss_newton import line_search_iterated_batch_gauss_newton_smoother
...
smoothed_traj, _ = line_search_iterated_batch_gauss_newton_smoother(observations, init_dist,
                                                                    trns_mdl, obs_mdl,
