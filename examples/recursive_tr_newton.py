...
from optsmooth.sequential._tr_newton import (
    trust_region_iterated_recursive_newton_smoother,
)
...
smoothed_traj, costs = trust_region_iterated_recursive_newton_smoother(
    observations,
    init_dist,
    trns_mdl,
    obs_mdl,
