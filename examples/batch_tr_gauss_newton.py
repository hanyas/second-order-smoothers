...
from optsmooth.batch._tr_gauss_newton import trust_region_iterated_batch_gauss_newton_smoother
...
smoothed_traj, costs = trust_region_iterated_batch_gauss_newton_smoother(observations, init_dist,
                                                                         trns_mdl, obs_mdl,
                                                                         extended, init_nominal_mean,
                                                                         lmbda=1e1, nu=2.0, nb_iter=25)

plt.figure(figsize=(7, 7))
plt.plot(smoothed_traj[:, 0], smoothed_traj[:, 1], "-*", label="Iterated Batch Gauss-Newton Smoother")
