...
from newton_smoothers import line_search_iterated_batch_gauss_newton_smoother
...
smoothed, _ = line_search_iterated_batch_gauss_newton_smoother(
...
plt.title("Iterated Batch Gauss-Newton Smoother with Line Search")
plt.grid()
plt.legend()
plt.show()
