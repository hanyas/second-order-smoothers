...
from newton_smoothers import trust_region_iterated_batch_newton_smoother
...
smoothed, costs = trust_region_iterated_batch_newton_smoother(
    init_nominal,
    observations,
    init_dist,
    trans_mdl,
...
plt.title("Iterated Batch Newton Smoother with Trust Region")
plt.grid()
plt.legend()
plt.show()
